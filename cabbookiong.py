...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Receiptt():
            if reset_counter is 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                self.txtReceipt1.insert(END,'Eurocopter:\n')
                self.txtReceipt2.insert(END, Standard.get() + "\n")
                self.txtReceipt1.insert(END,'Robinson R22:\n')
                self.txtReceipt2.insert(END, PrimeSedan.get() + "\n")
                self.txtReceipt1.insert(END,'Bell Boeing V22:\n')
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Bengaluru":
                    switch ={"Thiruvananthapuram": 600,"Mumbai": 900,"Chennai":400,"Bengaluru": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Chennai":
                    switch ={"Thiruvananthapuram": 700,"Mumbai": 1000,"Chennai":0,"Bengaluru": 400}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Mumbai":
                    switch ={"Thiruvananthapuram": 1300,"Mumbai": 0,"Chennai":1000,"Bengaluru": 900}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Thiruvananthapuram":
                    switch ={"Thiruvananthapuram": 0,"Mumbai": 1300,"Chennai":700,"Bengaluru": 600}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text="Helicopter Booking India")
        self.lblTitle.grid()
    ...
    #===============================================Taxi Information==============================================================
        ...
        self.cboPickup['value']=('','Bengaluru','Chennai','Mumbai','Thiruvananthapuram')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Bengaluru','Chennai','Mumbai','Thiruvananthapuram')
        self.cboDrop.current(0)
    ...
    #==========================================================taxiselect=======================================================================
        ...
        self.chkStandard=Radiobutton(Book_Frame,text="Eurocopter",value=1,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        ...
        self.chkPrimeSedand=Radiobutton(Book_Frame,text="Robinson R22",value=2,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        ...
        self.chkPremiumSedan = Radiobutton(Book_Frame,text="Bell Boeing v22",value=3,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=2, column=0)
